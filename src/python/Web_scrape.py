...
def web_scrape_lyrics(url, dataset):
    ...
    -----------------
    """
    genius = lyricsgenius.Genius("_F0e3onUyr31nflC3l2HUMOXl1xqX5ABSIPAd0PMpwLfy8ViEhxeDJESGV52IvlY", timeout=30, sleep_time=0.5, retries=3)
    with open(dataset, 'a', newline='', encoding='utf-8') as csvfile:
        ...
        while url is not None and consecutive_errors < 5:
