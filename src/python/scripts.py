...
from genius_functions import generate_csv, count_rows_in_csv

row_count = count_rows_in_csv('C:/Users/Daniel Day/Downloads/School/Data-399/data_capstone_399/data/song_lyrics.csv')
print(row_count)
generate_csv(top_10000, 'C:/Users/Daniel Day/Downloads/School/Data-399/data_capstone_399/data/song_lyrics.csv',start_index=row_count)
